...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_negatiivinen_lataaminen_ei_muuta_saldoa(self):
        ...
        self.assertEqual(self.kortti.saldo, 1000.0)

    def test_pystyy_ostamaan_maukas_lounas_jos_saldo_juuri_tarpeeksi(self):
        kortti = Maksukortti(400)
        kortti.syo_maukkaasti()

        self.assertEqual(kortti.saldo, 0.0)

    def test_pystyy_ostamaan_edullinen_lounas_jos_saldo_juuri_tarpeeksi(self):
